...
|---------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Comunica oralmente con <br> efectividad a diferentes rangos<br> de audiencia.   | **Anjali** <br/><br> **TB1:**<br/> Capítulo I, Diseño de entrevistas, Registro de tres entrevistas, análisis de entrevistas, User Personas, Capítulo IV, Class Diagrams, Database Diagram, Capítulo V. <br/><br> **TP:** Participó activamente en exposiciones grupales, explicando de forma clara los resultados del análisis de entrevistas y la representación de diagramas. <br/><br> **Pierina** <br/><br> **TB1:**<br/> Registro de entrevista, User Task Matrix, User Journey Mapping, Empathy Mapping, Impact Mapping, Web Applications Wireframes, Web Applications Mock-ups, Web Applications Prototyping. <br/><br> **TP:** Expuso los mapas de experiencia de usuario y prototipos, respondiendo preguntas del equipo con claridad y seguridad. <br/><br> **Quique** <br/><br> **TB1:**<br/> Registro de entrevista, User Task Matrix, User Journey Mapping, Empathy Mapping, Impact Mapping, Web Applications Wireframes, Web Applications Mock-ups, Product Backlog, Spring Backlog 1, Development Evidence for Sprint Review, Execution Evidence for Sprint Review, Services Documentation Evidence for Sprint Review, Software Deployment Evidence for Sprinte Review, Team collaboration insights during sprint. <br/><br> **TP:** Mostró habilidades para presentar avances técnicos del backlog y explicar los entregables de sprint de manera organizada. <br/><br> **Gonzalo** <br/><br> **TB1:**<br/> Análisis competitivo, Estrategias y táctica frente a competidores, User Stories, Web Applications Wireframes, Web Applications Mock-ups. <br/><br> **TP:** Explicó los resultados del análisis competitivo y las user stories destacando su relevancia para el proyecto. <br/><br> **Diego** <br/><br> **TB1:**<br/> Big Picture Event Storming, Ubiquitous Language, Landing Page UI Design, Web Applications Wireflow Diagrams, Web Applications User Flow Diagrams, Domain-Driven Software Architecture, Spring Planning 1, Aspect Leaders and Collaborators. <br/><br> **TP:** Expuso los diagramas de arquitectura y flujos de usuario con un lenguaje técnico adaptado al público. | **TP1:** <br/>Se demostró la capacidad de exponer avances, hallazgos y propuestas de manera clara y estructurada, utilizando un lenguaje adecuado para distintos públicos. Esto permitió una mejor comprensión de los resultados, facilitó la discusión en equipo y favoreció la retroalimentación durante las presentaciones y revisiones. |
| Comunica por escrito con <br> efectividad a diferentes rangos<br> de audiencia. | **Anjali** <br/><br> **TB1:**<br/> Capítulo I, Diseño de entrevistas, Registro de tres entrevistas, análisis de entrevistas, User Personas, Capítulo IV, Class Diagrams, Database Diagram, Capítulo V. <br/><br> **TP:** Redactó de forma organizada los capítulos del informe y los diagramas con explicaciones técnicas claras. <br/><br> **Pierina** <br/><br> **TB1:**<br/> Registro de entrevista, User Task Matrix, User Journey Mapping, Empathy Mapping, Impact Mapping, Web Applications Wireframes, Web Applications Mock-ups, Web Applications Prototyping. <br/><br> **TP:** Elaboró documentación clara sobre las herramientas de diseño de usuario y prototipos con lenguaje accesible. <br/><br> **Quique** <br/><br> **TB1:**<br/> Registro de entrevista, User Task Matrix, User Journey Mapping, Empathy Mapping, Impact Mapping, Web Applications Wireframes, Web Applications Mock-ups, Product Backlog, Spring Backlog 1, Development Evidence for Sprint Review, Execution Evidence for Sprint Review, Services Documentation Evidence for Sprint Review, Software Deployment Evidence for Sprinte Review, Team collaboration insights during sprint. <br/><br> **TP:** Documentó con precisión la evidencia de los sprints y los backlogs con orden y coherencia. <br/><br> **Gonzalo** <br/><br> **TB1:**<br/> Análisis competitivo, Estrategias y táctica frente a competidores, User Stories, Web Applications Wireframes, Web Applications Mock-ups. <br/><br> **TP:** Redactó reportes de análisis competitivo y user stories con lenguaje técnico adaptado. <br/><br> **Diego** <br/><br> **TB1:**<br/> Big Picture Event Storming, Ubiquitous Language, Landing Page UI Design, Web Applications Wireflow Diagrams, Web Applications User Flow Diagrams, Domain-Driven Software Architecture, Spring Planning 1, Aspect Leaders and Collaborators. <br/><br> **TP:** Produjo documentación técnica de diagramas y arquitecturas con precisión y claridad. | **TP1:** <br/>Se evidenció la habilidad para elaborar documentos técnicos y académicos con orden, coherencia y precisión, adaptando el nivel de detalle según la audiencia. Los entregables generados permitieron consolidar la información del proyecto, comunicar decisiones de diseño y respaldar el trabajo en equipo con insumos claros y comprensibles. |
...
<table>
  ...
  <tr>
    <td valign="top" align="center"><img src="assets/images/AgroTrack.jpg" alt="AgroTrack Logo" height="150" /></td>
    <td valign="top" align="center"><img src="assets/images/Space_AG.png" alt="Space AG Logo" height="80" /></td>
    <td valign="top" align="center"><img src="assets/images/AGROS.png" alt="AGROS Logo" height="150" /></td>
    <td valign="top" align="center"><img src="assets/images/AgriSoft.png" alt="AgriSoft Logo" height="130" /></td>
   </tr>
  <tr>
